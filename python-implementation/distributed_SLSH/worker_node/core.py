...
def execute_core(pipe, barrier, seed, m_out, n_tables, m_in, L_in, dataset, dataset_shape, H_out, H_in, alpha, k, points):
    '''
    ...
    :param points: which points to hash on the core
    ...
    (T_out, g_out, T_in, g_in) = slsh_indexing(
        m_out, n_tables, m_in, L_in, dataset_as_ndarray, dataset_shape, H_out, H_in, alpha, outer_points=points)
