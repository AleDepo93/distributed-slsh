...
class Query():
    ...
    def __init__(self, query_point):
        ...
        self.comparisons = 0  # Number of comparisons which were necessary for the query (max)

        # Experiment: store the number of average and minimum comparisons across cores per each query.
        self.mincomparisons = 0
        self.avgcomparisons = 0
