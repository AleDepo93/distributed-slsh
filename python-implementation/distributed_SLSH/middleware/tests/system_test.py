...
class TestDistributedSLSH(unittest.TestCase):
    ...
    def test_system(self):
        ...
        temp1, queries = execute_middleware(nodes_list, cores, filename, D, D, [query1, query2], k, synchronous=synchronous)
    ...
    def test_prediction_system(self):
        ...
        # Execute parallel code.
        temp1, queries = execute_middleware(nodes_list, cores, D, D, k, queries=[query1, query2], X=X, labels=labels,
                                            synchronous=synchronous, prediction=True)
